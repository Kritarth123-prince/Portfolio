...
<head>
  ...
  <title>Kritarth Portfolio</title>
...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <h2>I'm a passionate <span><?php echo $data['title']?></span> from New Delhi</h2>
    ...
    <div class="about-me container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
          <h3>Data Science &amp; Machine Learning Engineer</h3>
          <p class="fst-italic">
          ...
          <div class="row">
            <div class="col-lg-6">
              <ul>
                <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>29 Oct 2004</span></li>
                <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>www.makehimself.com</span></li>
                <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span><?php echo $data['contact-no']?></span></li>
